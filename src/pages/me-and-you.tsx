...
const MeAndYou = (props) => {
  ...
  useEffect(() => {
    setEventName(props.location.pathname.replace(/[/]/gi, ""))
  }, [controls])
  ...
  const sendWishes = async () => {
    mutate(
      `${process.env.BACKEND_URL}/inbox?eventName=${eventName}`,
      [
        ...inboxes,
        {
          name: senderName,
          ...
          >
            <div className="flex flex-col justify-center text-center w-screen fixed h-screen bg-white z-0">
              ...
              <div className="mt-6 mb-4">
                <h1 className="font-greatVibe text-5xl sm:text-8xl mb-8 font-bold">
                  Romeo & Juliet
                </h1>
                <button
                  onClick={enter}
                  className="bg-black p-4 text-white w-3/4 md:w-1/4 rounded"
                >
                  Enter
                </button>
              </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 text-center md:h-screen overflow-visible">
              ...
              >
                ...
                manusia." <br></br>
                <br></br>{" "}
                <span className="text-4xl md:text-6xl mt-4 font-bold">
                ...
                >
                  ...
                  <div className="flex justify-center mb-4 ">
                    <h4 className="text-center">
                      ...
                      pandemi, kami harapkan kedatangan para tamu undangan agar
                      menjalankan protokol yang berlaku.
                    </h4>
                  </div>
            ...
            <div className="flex justify-center mt-4 border-t-2 border-white">
              <div
                style={{ backgroundColor: "#e7e5d7" }}
                className="text-center w-screen"
              >
                <StaticImage
                  src="../images/floral+7+top-right.png"
                  width={150}
                  height={150}
                ...
                <p className="text-center text-md font-gab">
                ...
                <a href="https://www.google.com/maps/place/The+Apurva+Kempinski+Bali/@-8.8285465,115.2133893,17z/data=!3m1!4b1!4m8!3m7!1s0x2dd25cc0e01a2dfb:0x486d1b655b87ed9c!5m2!4m1!1i2!8m2!3d-8.8285465!4d115.2155844?hl=en-US">
                  <div
                    className="m-auto flex bg-gray-200 border-2 rounded-xl text-white text-sm w-max"
                    style={{
                ...
                <StaticImage
                  ...
                  src="../images/floral+7+bot-left.png"
                  width={150}
                  height={150}
                  alt="bottom"
                ></StaticImage>
                ...
                >
                  ...
                  <div className="flex justify-center mb-4 ">
                    <span className="text-center text-sm">
                      Sebelumnya, terimakasih atas perhatian dan bentuk tanda
                      kasih Bapak/Ibu/Saudara/i untuk kami. Silahkan kirimkan
                      dana melalui transfer rekening berikut :
                    </span>
                  </div>
                  <div className="flex justify-center mb-4 ">
                    <StaticImage
                      className="float-left"
                      src="../images/qr-dummy.jpeg"
                      width={150}
                      height={150}
                      alt="bottom"
                    ></StaticImage>
                ...
                <div className="w-full mt-4">
                  {inboxes.map((inbox, index) => {
                    return index % 2 === 0 ? (
                      <div
                        key={inbox.name}
                        className="rounded-xl p-2 text-center mb-2 border-2 border-white"
